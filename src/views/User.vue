<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <UserCommentsCard :initial-comments="profile.userComments" />
        <br />
        <UserFavoritedRestaurantsCard :initial-restaurants="profile.favoritedRestaurants" />
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    fetchUser(userId) {
      ...
      this.profile = {
        ...
        userComments: dummyData.profile.Comments,
